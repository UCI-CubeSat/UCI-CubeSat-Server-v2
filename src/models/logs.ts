...
const UnkownPowerLogValidator = z.object({
    operationState: z.union([
        z.literal(operationStates[0]),
        z.literal(operationStates[1]),
        z.literal(operationStates[2]),
        z.literal(operationStates[3])
    ]),
    panelVoltage: z.union([z.number(), z.null()]),
    panelCurrent: z.union([z.number(), z.null()]),
    satEventHistory: z.union([
        z.literal(satelliteEventHistory[0]),
        z.literal(satelliteEventHistory[1]),
        z.literal(satelliteEventHistory[2]),
...
export const DatabaseLogValidator = BaseLogValidator.merge(UnkownPowerLogValidator)
export type DatabaseLog = z.infer<typeof DatabaseLogValidator>
